...
It seems important to use async for these. This gives reasonable performance while writing. This is mostly works. If you type fast enough you can hit some errors where save/revert co
